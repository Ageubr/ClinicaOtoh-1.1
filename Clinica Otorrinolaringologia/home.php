...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="./agendar_consulta.php">Agendamentos</a></li>
                <li><a href="./consulta_handler.php">Consultas</a></li>
    ...
    <main>
        <section id="about">
            ...
            <p class="about-text">A Clínica Otoh é especializada em otorrinolaringologia e foi fundada em 2010, localizada em Taguatinga Sul, Brasília-DF. Nossa missão é oferecer tratamentos de alta qualidade para uma variedade de condições relacionadas a ouvido, nariz e garganta.</p>
        </section>
